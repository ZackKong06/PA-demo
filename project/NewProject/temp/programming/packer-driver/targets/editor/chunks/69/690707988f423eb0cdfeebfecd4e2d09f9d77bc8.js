  ...
  return {
    ...
    execute: function () {
      ...
      _export("ProceduralFactory", ProceduralFactory = class ProceduralFactory {
        ...
        createEnemy(name, parent, strength = 1) {
          const root = new Node(name);
          root.setParent(parent);
          const bodyColor = strength === 3 ? new Color(59, 183, 103) : strength === 2 ? new Color(132, 68, 196) : new Color(221, 69, 79);
          const darkColor = strength === 3 ? new Color(30, 91, 59) : strength === 2 ? new Color(57, 34, 88) : new Color(82, 36, 41);
          const baseColor = strength === 5 ? new Color(255, 67, 75) : strength === 3 ? new Color(181, 84, 245) : strength === 2 ? new Color(70, 155, 255) : new Color(67, 224, 125);
